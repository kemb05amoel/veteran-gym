        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-8 text-center">
            <div class="card shadow-lg p-4" data-bs-theme="dark">
              <h2 class="text-center fw-bold mb-4" style="color: var(--accent-hover);">Terima Kasih</h2>
              <p class="fs-5">
                Konfirmasi pembayaran Anda telah kami terima.
              </p>
              <p class="fs-8">
                Admin kami akan segera melakukan verifikasi (maksimal 1x24 jam).
                Membership Anda akan diaktifkan setelah pembayaran divalidasi.
              </p>

              <hr class="my-4" style="border-color: var(--accent-hover);">

              <p class="text-light small">
                Anda bisa mengecek status pembayaran Anda secara berkala melalui tombol di bawah ini:
              </p>
              <a href="cek_status_membership.php" class="btn btn-pay mt-2">
                <i class="bi bi-search me-2"></i> Cek Status Pembayaran Saya
              </a>
              <a href="../index.php" class="btn btn-outline-secondary mt-2">Kembali ke Beranda</a>

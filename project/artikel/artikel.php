...
<head>
    ...
    <title>Veteran Gym | Artikel</title>
...
<body>
    ...
    <section id="artikel-section">
        <div class="artikel-container">
            <h2 class="artikel-title">Berita & Prestasi Veteran Gym</h2>
            <p class="text-center mb-5" style="color: var(--text-muted);">
                Ikuti perkembangan terbaru, raihan prestasi, dan inovasi program dari Veteran Gym. Kami berjuang untuk
                menjadi yang terbaik.
            </p>

            <div class="artikel-grid">
                <?php
                // 2. QUERY DATABASE (Urutkan dari yang terbaru / tanggal DESC)
